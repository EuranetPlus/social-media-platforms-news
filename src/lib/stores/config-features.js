export const config = {
  "mapTitle": "social-media-platforms-news", // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
  "vercelURL": "https://social-media-platforms-news.vercel.app/", // The url provided when deploying the map on Vercel
